/obj/item/gun/energy/sniper
	...
	icon = 'ModularLobotomy/_Lobotomyicons/energy_sniper.dmi'
	//lefthand_file = 'ModularLobotomy/_Lobotomyicons/energy_sniper_l.dmi'
	//righthand_file = 'ModularLobotomy/_Lobotomyicons/energy_sniper_r.dmi'
