...
/obj/item/radio/talk_into(atom/movable/M, message, channel, list/spans, datum/language/language, list/message_mods, direct = TRUE) //QUASAR-13 EDIT CHANGE - GUNPOINT
...
/obj/item/radio/Hear(message, atom/movable/speaker, message_language, raw_message, radio_freq, list/spans, list/message_mods = list())
	...
	talk_into(speaker, raw_message, , spans, language=message_language, direct=FALSE) //QUASAR-13 EDIT CHANGE - GUNPOINT
