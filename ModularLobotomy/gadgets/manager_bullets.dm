...
/obj/item/managerbullet/suicide_act(mob/living/carbon/user)
	...
	if(ishuman(user))
		...
		H.Stun(10)
	playsound(get_turf(user), 'ModularLobotomy/_Lobotomysounds/weapons/guns/manager_bullet_fire.ogg', 10, 0, 3)
...
/datum/status_effect/interventionshield
	...
	var/statuseffectvisual = icon('ModularLobotomy/_Lobotomyicons/tegu_effects.dmi', "red_shield")
...
/datum/status_effect/interventionshield/white
	id = "trauma shield"
	statuseffectvisual = icon('ModularLobotomy/_Lobotomyicons/tegu_effects.dmi', "white_shield")
	respectivedamage = list(WHITE_DAMAGE)

/datum/status_effect/interventionshield/black
	id = "erosion shield"
	statuseffectvisual = icon('ModularLobotomy/_Lobotomyicons/tegu_effects.dmi', "black_shield")
...
/datum/status_effect/interventionshield/perfect
	id = "perfect shield"
	statuseffectvisual = icon('ModularLobotomy/_Lobotomyicons/tegu_effects.dmi', "manager_shield")
	respectivedamage = list(RED_DAMAGE, WHITE_DAMAGE, BLACK_DAMAGE, PALE_DAMAGE)

/datum/status_effect/interventionshield/quad
	id = "quad shield"
	statuseffectvisual = icon('ModularLobotomy/_Lobotomyicons/tegu_effects.dmi', "quad_shield")
	respectivedamage = list(RED_DAMAGE, WHITE_DAMAGE, BLACK_DAMAGE, PALE_DAMAGE)
