...
/obj/item/toy/balloon/syndicate/gold
	...
	random_color = FALSE
	icon = 'ModularLobotomy/_Lobotomyicons/phoenix_nest/balloon.dmi'
	icon_state = "syndballoongold"
	inhand_icon_state = "syndballoongold"
	lefthand_file = 'ModularLobotomy/_Lobotomyicons/phoenix_nest/balloons_lefthand.dmi'
	righthand_file = 'ModularLobotomy/_Lobotomyicons/phoenix_nest/balloons_righthand.dmi'
