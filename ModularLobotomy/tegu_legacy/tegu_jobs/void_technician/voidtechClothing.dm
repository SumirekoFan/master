...
/obj/item/clothing/under/rank/engineering/void
	...
	worn_icon = 'ModularLobotomy/_Lobotomyicons/kirie_stuff/voidtech.dmi'
	icon_state = "voidtech"
	icon = 'ModularLobotomy/_Lobotomyicons/kirie_stuff/voidtech_icon.dmi'
	inhand_icon_state = "void_suit"
	lefthand_file = 'ModularLobotomy/_Lobotomyicons/teguclothing_hold_left.dmi'
	righthand_file = 'ModularLobotomy/_Lobotomyicons/teguclothing_hold_right.dmi'
