...
/obj/item/clothing/shoes/laceup/digitigrade
	...
	tegu_item = TRUE
	icon = 'ModularLobotomy/_Lobotomyicons/shoes_tegu.dmi'
	icon_state = "digi_laceups"
	worn_icon = 'ModularLobotomy/_Lobotomyicons/feet_tegu.dmi'
...
//	alternate_worn_icon = 'ModularLobotomy/_Lobotomyicons/feet_tegu.dmi'
