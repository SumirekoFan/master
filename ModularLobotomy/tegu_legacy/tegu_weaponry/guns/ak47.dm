/obj/item/gun/ballistic/automatic/ak47
	...
	icon = 'ModularLobotomy/_Lobotomyicons/48x32_guns.dmi'
	icon_state = "ak47"
	base_pixel_x = -8
	fire_sound = 'ModularLobotomy/_Lobotomysounds/weapons/guns/ak47.ogg'
	burst_size = 1
	actions_types = list()
	mag_display = TRUE
...
/obj/item/ammo_box/magazine/ak47
	...
	icon = 'ModularLobotomy/_Lobotomyicons/magazines.dmi'
